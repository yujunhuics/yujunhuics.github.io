...
var loading_visit = (color) => {
  loading =
    ...
    color +
    '" d="M25.251,6.461c-10.318,0-18.683,8.365-18.683,18.683h4.068c0-8.071,6.543-14.615,14.615-14.615V6.461z" transform="rotate(275.098 25 25)"/><animateTransform attributetype="xml" attributename="transform" type="rotate" from="0 25 25" to="360 25 25" dur="0.6s" repeatcount="indefinite"/></svg></div>';
  return loading;
};
...
(function init() {
  ...
  visit_calendar("17906954", "121.1852ec40d1a045e071ce77407d007c51.YCJdhudvWucXWsi_5yp-t_Ru9ktAy_YkECz3YwQ.phSFnw", "pv_count", visit_color);
})();
